...
-(void)setSchedule{
    ...
    NSDictionary * paraDic = @{@"swuid":@"222017321062084",@"academicYear":@"2018",@"term":@"1"};
    [manager POST:@"https://freegatty.swuosa.xenoeye.org/ac/register" parameters:paraDic progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
